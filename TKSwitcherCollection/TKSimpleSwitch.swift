...
open class TKSimpleSwitch:  TKBaseSwitch {
    ...
    override internal func setUpView() {
        ...
        backgroundLayer.strokeColor = stateToFillColor(true)
    ...
    open func changeValueAnimate(_ turnOn:Bool, duration:Double) {
        ...
        let strokeFillColorAnim      = CAKeyframeAnimation(keyPath:"strokeColor")
        strokeFillColorAnim.values   = [stateToFillColor(!turnOn),
                                        stateToFillColor(!turnOn),
                                        stateToFillColor(turnOn),
                                        stateToFillColor(turnOn)]
        strokeFillColorAnim.keyTimes = [0,0.5,0.51,1]
        strokeFillColorAnim.duration = duration
        strokeFillColorAnim.fillMode = kCAFillModeForwards
        strokeFillColorAnim.isRemovedOnCompletion = false
        ...
        backgroundLayer.add(strokeFillColorAnim, forKey: "StrokeColor")
    }
